...
//    添加选课消息队列
    ...
    /**
    * @description: 声明完成添加选课消息队列
    * @author: 沈煜辉
    * @create: 2020/3/20 13:55
    **/
    @Bean(XC_LEARNING_FINISHADDCHOOSECOURSE)
    public Queue QUEUE_DECLAREFINISH() {
    ...
    **/
     ...
     */
    @Bean
    public Binding binding_queue_media_chooseTask(@Qualifier(XC_LEARNING_ADDCHOOSECOURSE) Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange){
