...
public enum LearnCode implements ResultCode {
    LEARNING_MEDIAURL_ERROR(false,22501,"无法为该课程计划添加视频！"),
    LEARNING_ADDCOURSE_USERIDISNULL(false,22502,"用户信息为空！"),
    LEARNING_ADDCOURSE_COURSEIDISNULL(false,22503,"课程信息为空！");
