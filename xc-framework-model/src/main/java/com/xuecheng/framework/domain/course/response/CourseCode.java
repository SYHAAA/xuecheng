...
public enum CourseCode implements ResultCode {
    ...
    COURSE_SAVE_NAMEEXIST(false,31006,"课程已存在！"),
    COURSE_MEDIS_URLISNULL(false,31101,"选择的媒资文件访问地址为空！"),
    COURSE_MEDIS_NAMEISNULL(false,31102,"选择的媒资文件名称为空！"),
    COURSE_FIND_NOTEXIST(false,31103,"课程不存在！"),
    COURSE_POST_ERROR(false,31104,"发布页面出错！"),
    COURSE_INDEX_ERROR(false,31105,"创建课程索引信息失败！"),
    COURSE_TEACHPLAN_NOTEXIST(false,31106,"课程计划不存在！"),
    COURSE_TEACHPLAN_NOTCHECKMEDIA(false,31107,"无法为该课程计划添加视频！");
